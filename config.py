...
train_file = os.path.join(home, "datasets/original", "SQuAD", "train-v1.1.json")
dev_file = os.path.join(home, "datasets/original", "SQuAD", "dev-v1.1.json")
test_file = os.path.join(home, "datasets/original", "SQuAD", "dev-v1.1.json")
glove_word_file = os.path.join(home, "datasets/original", "Glove", "glove.840B.300d.txt")
target_dir = "datasets/processed/SQuAD"
event_dir = "log"
save_dir = "model"
answer_dir = "log"
